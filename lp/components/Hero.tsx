      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base text-text-muted sm:text-lg leading-relaxed">
            あなたの広告運用スキルに、<strong className="text-text">30のAI自動化ツール</strong>を掛け合わせる。
            <br className="hidden sm:block" />
            分析スピード、施策の打ち手、レポート精度
            ―― すべてが<span className="text-accent font-medium">一段上のレベル</span>になる。
          </p>
        ...
        <div className="mt-12 sm:mt-16">
          <div className="relative rounded-xl border border-border bg-surface-light/60 p-2 sm:p-3 shadow-2xl backdrop-blur overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-8 sm:h-10 bg-surface-light/90 border-b border-border flex items-center px-3 sm:px-4 gap-1.5 z-10">
          ...
          <p className="mt-3 sm:mt-4 text-center text-xs text-text-muted">
