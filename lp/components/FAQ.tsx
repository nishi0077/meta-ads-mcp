...
const faqs = [
  ...
  {
    q: "セキュリティは大丈夫ですか？",
    a: "はい。Meta公式のOAuth 2.0認証を使用しており、パスワードを預かることはありません。通信はすべてSSL暗号化され、広告データが外部に漏れることはありません。企業の広告アカウントでも安心してご利用いただけます。",
  },
  {
    q: "解約はいつでもできますか？",
  ...
  {
    q: "返金保証はありますか？",
    a: "はい。購入後7日以内であれば、理由を問わず全額返金します。実際に使ってみて判断してください。",
  },
];
